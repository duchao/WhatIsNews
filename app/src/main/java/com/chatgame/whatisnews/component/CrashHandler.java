...
import com.chatgame.whatisnews.utils.LogUtil;
import com.chatgame.whatisnews.utils.ToastUtil;
...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        ...
        ToastUtil.shortShow(App.getInstance().getString(R.string.toast_app_error));
